        ...
        public void RenderTile(SpriteBatch spriteBatch, Rectangle bounds, TextureAtlas atlas, byte mooreState, byte tileID)
        {
            switch (_tileTypes[tileID].RenderType)
            {
                case RenderType.Land:
                    spriteBatch.Draw(atlas.Texture, bounds, atlas.GetSource(_tileTypes[tileID].TextureID + mooreState), Color.White);
                    break;
                case RenderType.Prop:
                    spriteBatch.Draw(atlas.Texture, bounds, atlas.GetSource(_tileTypes[tileID].TextureID), Color.White);
                    break;
            }
        }

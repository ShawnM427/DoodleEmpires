...
namespace DoodleEmpires.Engine.Terrain
{
    public class ChunkedTerrainRenderer
    {
        ...
        public ChunkedTerrainRenderer(VoxelTerrain terrain)
        {
                    ...
                    for (int xx = 0; xx < 2; xx++)
                    {
                        for (int yy = 0; yy < 2; yy++)
                        {
                            verts[i] = new VertexPositionColorTexture(new Vector3(
                                    (float)(chunkX * CHUNK_WIDTH + x) * VoxelTerrain.TILE_WIDTH,
                                    (float)(chunkY * CHUNK_WIDTH + y) * VoxelTerrain.TILE_HEIGHT, 0),
